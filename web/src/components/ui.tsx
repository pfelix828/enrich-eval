...
export function SyntheticDataNote({ className }: { className?: string }) {
  return (
    <p className={clsx("text-xs text-muted", className)}>
      All numbers come from a <strong>55-row synthetic seed</strong> scored by a deterministic rules
      enricher — a methodology demonstration, not production metrics. See{" "}
