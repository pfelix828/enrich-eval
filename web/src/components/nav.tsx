...
const items = [
  ...
  { href: "/regression", label: "Regression Gate" },
    ...
    <header className="sticky top-0 z-20 border-b border-border-subtle bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center gap-6 px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          <span className="grid h-7 w-7 place-items-center rounded-md bg-accent text-sm font-black text-white">E</span>
          <span className="text-sm font-bold tracking-tight">
            EnrichEval
            <span className="ml-2 hidden font-normal text-muted sm:inline">a quality lab for transaction enrichment</span>
          </span>
        </Link>
